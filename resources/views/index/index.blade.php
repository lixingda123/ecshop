  ...
  <body>
    <div class="maincont">
     ...
     <ul class="reg-login-click">
      @if(session('user'))
       <li><a href="">欢迎 : {{session('user.user_email')}}</a><a href="/login/quit">退出</a></li>
      @else
     ...
     @foreach($res as $v)
      <div class="index-pro1-list">
       <dl>
        <dt><a href="/proinfo/proinfo/{{$v->goods_id}}"><img src="{{config('app.img_url')}}{{$v->goods_img}}" /></a></dt>
        <dd class="ip-text"><a href="/proinfo/proinfo/{{$v->goods_id}}">{{$v->goods_name}}</a><span>已售：488</span></dd>
